...
export default function EditarConversation({ titulo, logoEmpresas }) {
  const { id } = useParams();

  const data = [
    {
      id: 1,
      titulo: "Conversacion Grupal",
      moderador: "Juan Stiven Rangel",
      introduccion: "Encuesta de socialización grupal",
  ...
  const closeModal = () => {
    setShowModal(false);
    handleLinkClick("Dynamic Live Conversations");
  };
